        ...
        <div className="flex h-screen">
          <div className="hidden md:block h-full bg-yellow-500/45 px-14 w-[400px] tablet:w-[600px]">
            <div className="flex flex-col justify-evenly h-auto pt-16 gap-y-14">
              <div>
                <h1 className="font-header mb-5 text-lg text-yellow-700/80 tracking-widest">
                  dribbble
                </h1>
                <h1 className="text-xl font-extrabold text-yellow-900/80 font-inter">
          ...
          <div className="h-full pt-3 w-full overflow-auto">
            <div className="flex flex-row justify-end w-full pr-5">
              <p className="font-medium mr-2">
                Already a member?
                <span>
                  <a href="#" className="text-[#816391] ml-2">
                    Sign In
                  </a>
                </span>
                <button className='ml-2'>
                  <a href="/create-profile">Skip</a>
                </button>
              </p>
            </div>
            <div className="flex flex-col items-center gap-2.5 w-full">
              ...
              {usernameError && (
                <p className="font-medium text-red-500 w-[344px] sm:w-[524px] md:w-[424px]">
                  &bull; Username already taken
                </p>
              )}
              {emailError && (
                <p className="font-medium text-red-500 w-[344px] sm:w-[524px] md:w-[424px]">
                  &bull; Email already taken
                </p>
              )}
              {passwordError && (
                <p className="font-medium text-red-500 w-[344px] sm:w-[524px] md:w-[424px]">
                  &bull; Password should contain at least 6 letters
                </p>
              )}
              {/* form validation sentence */}
              <div className="flex flex-col items-center pt-12">
                ...
                >
                  <div className="flex flex-row justify-center gap-6">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        className="bg-slate-200 px-2 py-1 rounded-md text-sm font-medium w-[160px] sm:w-[250px] md:w-[200px]"
                      />
                    </div>
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        className="bg-slate-200 px-2 py-1 text-sm font-medium rounded-md w-[160px] sm:w-[250px] md:w-[200px]"
                      />
                    </div>
                  </div>
                  <div className="flex flex-row justify-center">
                    <div className="flex flex-col w-[344px] sm:w-[524px] md:w-[424px]">
                      ...
                      <input
                        ...
                        className="bg-slate-200 px-2 py-1 text-sm font-medium rounded-md"
                      />
                    </div>
                  </div>
                  <div className="flex flex-row justify-center">
                  ...
                  <div className="flex flex-row justify-center">
                    <div className="flex flex-row w-[344px] sm:w-[524px] md:w-[424px]">
                      <input
                        type="checkbox"
                        id="pp"
                        className="mr-2 w-8 h-8 rounded-none border-none"
                        required
                      />
                      <label htmlFor="pp" className="text-sm">
                        Creating an account means you're okay with our
                        <span className="text-[#b271d4] font-medium">
                  ...
                  <div>
                    <div>
                      <button className="bg-[#EA4B8B] px-10 py-1 rounded-md text-white hover:bg-[#ea4b8bc4]">
                        Create Account
                      </button>
                    </div>
